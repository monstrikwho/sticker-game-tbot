...
export const ArrowLeftSVG = () => <svg className="bi bi-arrow-left" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowRightSVG = () => <svg className="bi bi-arrow-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const BackDoorSVG = () =>   <svg className="bi bi-box-arrow-in-left" width="1.75rem" height="1.75rem" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
